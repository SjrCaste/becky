...
export const metadata: Metadata = {
  title: "Novias Couture | Sedería Becky",
      ...
      <div className="pt-28 md:pt-36 pb-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative aspect-[16/6] w-full overflow-hidden border border-border/60 mb-12 flex items-center justify-center group bg-foreground">
            <Image
              src="https://images.unsplash.com/photo-1594552072238-b8a33785b261?auto=format&fit=crop&w=1600&q=90"
              alt="Línea Novias Sedería Becky"
              fill
          ...
          <div className="max-w-2xl mx-auto text-center mb-16 space-y-4">
            <p className="font-serif text-lg md:text-xl text-foreground">
              “Un vestido diseñado para trascender en el recuerdo.”
            </p>
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
              Nuestra línea bridal combina siluetas clásicas con cortes modernos y audaces. Utilizamos tejidos importados finos y confeccionamos cada pieza de manera artesanal y minuciosa, logrando una caída arquitectónica perfecta.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="border-t border-border pt-3 mt-auto flex justify-between items-center text-[10px]">
                    <span className="text-muted-foreground">Alta Costura</span>
