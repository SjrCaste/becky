...
export const metadata: Metadata = {
  title: "Padrinos, Madrinas & Cortejo | Sedería Becky",
      ...
      <div className="pt-28 md:pt-36 pb-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative aspect-[16/6] w-full overflow-hidden border border-border/60 mb-12 flex items-center justify-center group bg-foreground">
            <Image
              src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&w=1600&q=90"
              alt="Línea Padrinos y Madrinas Sedería Becky"
              fill
          ...
          <div className="max-w-2xl mx-auto text-center mb-16 space-y-4">
            <p className="font-serif text-lg md:text-xl text-foreground">
              “Elegancia para quienes acompañan el gran día.”
            </p>
            <p className="text-xs md:text-sm text-muted-foreground leading-relaxed font-light">
              Madrinas sofisticadas con conjuntos de seda salvaje y encajes Richelieu, y padrinos con sastería fina a medida en lanas importadas. Nos enfocamos en destacar tu rol con elegancia y confort en la ceremonia.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="border-t border-border pt-3 mt-auto flex justify-between items-center text-[10px]">
                    <span className="text-muted-foreground">Couture Familia</span>
